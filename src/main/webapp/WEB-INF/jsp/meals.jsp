...
<section>
    ...
    <hr/>
    <a href="${pageContext.request.contextPath}/meals/add?action=create"><spring:message code="meal.add"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
            <th><spring:message code="meal.dateColumn"></spring:message></th>
            <th><spring:message code="commonMeal.description"></spring:message></th>
            <th><spring:message code="commonMeal.calories"></spring:message></th>
            <th></th>
            <th></th>
        </tr>
        </thead>
