...
abstract public class AbstractMealServiceTest extends AbstractServiceTest {
    ...
    @Test
    public void getAll() {
        MATCHER.assertMatch(mealService.getAll(USER_ID), meals);
    }

    @Test
    public void getBetweenInclusive() {
        MATCHER.assertMatch(mealService.getBetweenInclusive(
    ...
    public void getBetweenWithNullDates() {
        MATCHER.assertMatch(mealService.getBetweenInclusive(null, null, USER_ID), meals);
    }
}
